...
export default function KYCSubmission() {
  ...
  const validateStep = (step: number) => {
    switch (step) {
      case 1:
        return formData.name && formData.email && formData.phone && formData.pan && formData.dateOfBirth;
      case 2:
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">KYC Submission Successful</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold text-slate-800 mb-4">KYC Submitted Successfully!</h1>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-mono text-sm font-semibold">{submittedRecord.id}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm">{new Date(submittedRecord.createdAt).toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-500">Verification Level</p>
                    <Badge variant="outline">{submittedRecord.verificationLevel}</Badge>
                  </div>
                </div>
                {submittedRecord.blockchainTxHash && (
                  <div>
                    <p className="text-sm text-slate-500">Blockchain Transaction</p>
                    <p className="font-mono text-xs break-all">{submittedRecord.blockchainTxHash}</p>
                  </div>
                )}
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-800">eKYC Verify</h1>
                <p className="text-xs text-slate-500">Submit Your KYC Documents</p>
              </div>
            </div>
            <Link to="/">
      ...
      <div className="bg-white/60 backdrop-blur-sm border-b border-slate-200/50 py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-lg font-semibold text-slate-800">KYC Submission Process</h2>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent className="space-y-6">
                <div className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center">
                  ...
                  <h3 className="text-lg font-medium text-slate-700 mb-2">Upload Identity Documents</h3>
                  <p className="text-slate-500 mb-4">
                    Upload PAN Card, Aadhaar, Passport, or other identity documents
                  </p>
                  <input
                    type="file"
                    multiple
          ...
          {currentStep === 4 && (
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p><span className="text-slate-500">PAN:</span> {formData.pan}</p>
                      <p><span className="text-slate-500">DOB:</span> {formData.dateOfBirth}</p>
                    </div>
                  </div>
                  <div>
                ...
                <div>
                  <h4 className="font-medium text-slate-700 mb-3">Documents ({selectedFiles.length})</h4>
                ...
                <Alert className="border-blue-200 bg-blue-50">
                  ...
                  <AlertDescription className="text-blue-800">
                    Your documents will be encrypted and stored securely. Document hashes will be recorded on the blockchain for immutable verification.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
